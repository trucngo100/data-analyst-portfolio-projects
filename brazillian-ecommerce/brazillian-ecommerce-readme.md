...
- The cohort chart revealed the extremely low retention rate (0.1% ~ 0.5%). New customers in any given month almost never return in subsequent months.
- **To understand why buyers do not have interest to stay and make frequent purchases on our platform. I decided to take a look back at their customer journey, from their online purchase experience, to post-purchase experience like receiving products and writing reviews.**
...
- My assumption is that a good **customer experience**, reflected through a good review score, would be the main motivation for customers to make subsequent purchases. Yes! The visualization unfolded that my hypothesis about the delivery and product review is true. Faster delivery leads to higher review scores, which could subsequently ends in a revisit.
  
#### *VIEW 4* - Inspecting Seller Retention, Acquisition, and Retention
| ![image alt](https://github.com/trucngo100/data-analyst-portfolio-projects/blob/main/assets/ecommerce_4.png)  |
|------------------------|
##### INSIGHTS FOR SELLER RETENTION & ACQUISITION
- Assuming that seller retention also relies on how they were first contacted, I dived deeper into the CRM activities of the company by building lookup table for SDRs.
...
#### *VIEW 5* - Big Picture of Olist Seller and Buyer Network
